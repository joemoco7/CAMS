...
main_script_path = os.path.join(script_directory, "church_attendance.py")
...
if not os.path.exists(main_script_path):
    print(f"Error: The main script 'church_attendance.py' was not found at {main_script_path}")
    sys.exit(1)
